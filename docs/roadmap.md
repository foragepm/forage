...
* Refactor core data model of https://github.com/foragepm/forage to implement draft spec
* Deploy analytics service for monitoring DHT for package usage
* Build and deploy marketing website for https://github.com/foragepm/forage and onboard early adopters
...
* Publish v1 of https://github.com/foragepm/forage
